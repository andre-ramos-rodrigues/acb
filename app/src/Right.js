...
const Right = () => {
  return (
    <main className="bg-gray-600 w-[100%] min-h-[100%] text-white p-7 flex flex-row justify-center items-center align-center">
          <Image
              src="/psi.jpg"
              alt="Logo"
              className="bg-neutral-400 rounded-full aspect-square object-cover mt-[-120px]"
              width={360}
              height={360}
              priority
            />
