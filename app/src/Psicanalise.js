...
const Psicanalise = () => {
    return ( //  bg-neutral-200
      <div className=' bg-slate-50 text-neutral-700 font-light w-[100%] min-h-[300px] p-7  flex justify-center align-center items-center'>
       ...
       */} 
        ...
        */}
        ...
        A psicanálise entende que estar e se movimentar no mundo em que vivemos é desconfortável, portanto eliminar o mal-estar de viver também seria retirar as possibilidades de satisfação e prazer que encontramos na vida. Entender e aprender novas formas de se relacionar com as singularidades de seu próprio desconforto possibilita colocar em movimento o que cada um constrói como felicidade.
        </div>
